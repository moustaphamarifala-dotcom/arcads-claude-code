...
export const PILIERS: Pilier[] = [
  {
    ...
    part: 4,
    formats: [
      "Avant / après sur un tissu",
      "Devine le prix de cette tenue",
      "Erreur que font 9 clients sur 10",
      "Transformation en accéléré (timelapse)",
      "Réaction à une tendance du moment",
      "Comparaison : le vrai vs le faux",
    ],
  },
  {
    id: "convaincre",
    ...
    formats: [
      ...
      "Comment je choisis mes tissus",
      "Réponse à une objection fréquente",
      "Détail des finitions en gros plan",
      "Une journée dans mon travail",
  ...
  },
  {
    ...
    nom: "Prouver",
    emoji: "⭐",
    objectif: "Montrer que d'autres ont déjà acheté et sont contents.",
    part: 2,
    formats: [
      "Témoignage client filmé ou capture d'écran",
      "Livraison / réception de commande",
      "Client qui porte la tenue en situation",
      "Commande refaite sur mesure",
  ...
  },
  {
    ...
    nom: "Vendre",
    emoji: "💰",
    objectif: "Demander clairement la commande.",
    part: 1,
    formats: [
      "Offre de la semaine avec date limite",
      "Nouvelle pièce disponible maintenant",
      "Stock restant annoncé",
...
/**
 * Créneaux de publication — heure locale GMT (Dakar, Bamako, Abidjan, Conakry).
